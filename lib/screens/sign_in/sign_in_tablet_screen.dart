...
class _$SignInTabletScreen extends StatefulWidget {
  const _$SignInTabletScreen({required this.signIn});
...
class _SignInTabletScreen extends State<_$SignInTabletScreen> {
  @override
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                          onPressed: () => GoRouter.of(context).goNamed(SignUpScreen.routeName),
                          child: RichText(
                            text: TextSpan(
