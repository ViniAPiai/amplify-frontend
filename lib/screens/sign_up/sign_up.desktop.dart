...
class _$SignUpDesktop extends StatefulWidget {
  const _$SignUpDesktop({super.key});

  @override
  createState() => _SignUpDesktop();
}

class _SignUpDesktop extends State<_$SignUpDesktop> {
  @override
