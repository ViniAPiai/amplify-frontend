...
class _$SignUpTabletScreen extends StatefulWidget {
  const _$SignUpTabletScreen({super.key});

  @override
  createState() => _SignUpTabletScreen();
}

class _SignUpTabletScreen extends State<_$SignUpTabletScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Center(child: IconButton(onPressed: () => GoRouter.of(context).go("/"), icon: FaIcon(FontAwesomeIcons.arrowLeft))),
        actions: [
          Padding(
        ...
        return Container(
          ...
          child: Stepper(
            ...
            steps: [
              ...
              Step(
                  title: provider.currentStep == 1
                      ? Text("Endereço", style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w500))
                      : const SizedBox(),
              ...
              Step(
                  title: provider.currentStep == 2
                      ? Text("Informações Pessoais", style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w500))
                      : const SizedBox(),
              ...
              return Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(provider.currentStep == 2 ? "Finalizar" : "Próximo",
