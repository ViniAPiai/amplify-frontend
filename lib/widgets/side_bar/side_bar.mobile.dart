...
class _SideBarMobile extends State<_$SideBarMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<SideBarBloc, SideBarState>(
      ...
      child: Scaffold(
        key: key,
        appBar: bloc.state.showNewAppointmentModal || bloc.state.showAppointmentDetailsModal ? null : widget.appBar,
                  ...
                  BlocProvider(
                    ...
                    child: AnimatedPositioned(
                        ...
                        child: Container(
                            ...
                            child: state.showClinicalExamModal ? AppointmentClinicalExamModal() : AppointmentDetailsModal(width: context.width,))),
                  ),
              ],
            );
          },
